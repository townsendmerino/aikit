...
| `dotI8Tile4x4` (`dot_i8_tile_arm64.s`, **added 2026-09-03**, S-01b) | every W8A8 call at M≥4, arm64 + DotProd — true of the BATCH entry only since audit M-01 (2026-09-10); `MatmulBTW8A8Batch` carried its own per-pair loop and never reached this tile | 1.5 per 16 int8 MACs (8 loads + 16 SDOT per 256) | 1 | **16 int32** | SDOT issue, **measured 3.98/cy** | 203.6 GMAC/s (`TestSDOTIssuePeak`) | 163.5 | **80%** |
