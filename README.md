...
| `decoder` | generic decoder-only LLM forward pass — Gemma 3, Qwen2.5/3, Llama-2/3, Mistral, GPT-2, Mixtral + Mellum2 (MoE, sliding/full interleave, YaRN); f32/bf16/f16 + int8/int8×int8/int4, safetensors/sharded/GGUF; HF logit parity | `embed`, `tokenizer`, `github.com/cogentcore/webgpu` (WebGPU backend) |
